...
export const createThemeProvider = (ReactLike: ReactType) => {
  class ThemeProvider extends ReactLike.Component<Props> {
    ...
    render() {
      ...
      return ReactLike.Children.only(this.props.children)
    }
  }
